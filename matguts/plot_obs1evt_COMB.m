...
set(gca,'FontSize',15,'YTick',[],'position',[0.16 0.11 0.75 0.815], 'box','on','linewidth',1.5,'layer','top')
...
% colourbar
patch([-70 -20 -20 -70 -70],[27.8 27.8 29.3 29.3 27.8],'w','edgecolor','none')
tkvl = agelim(1):2:agelim(2);
cbar_custom(gca, 'location',[-67 -22 28.1 29.],'tickside','bottom',...
    'lims',agelim,'tickvals',tkvl,'cmap',flipud(jet),...
    'FontSize',13,'FontWeight','bold',...
	'title','\textbf{Age (Ma)}','interpreter','latex');
