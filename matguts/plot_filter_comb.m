...
if strcmp(TorF,'T')
    plot(1./faxis./pi./2,abs(h),'Linewidth',2,'color',colour_get(Tmids(iw),max(Tmids),min(Tmids))); 
elseif strcmp(TorF,'F')
    plot(faxis.*pi.*2,abs(h),'Linewidth',2,'color',colour_get(Tmids(iw),max(Tmids),min(Tmids))); 
end
