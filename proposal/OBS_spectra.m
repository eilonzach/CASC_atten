...
OBS = {'J52C','J53C','J57C','J64C','J65C',...
       'J41C','J43C','J46C','J47C','J48C',...
       'J30C','J31C','J32C','J33C','J34C','J35C','J37C','J39C',...
       'J21C','J23C','J25C','J26C','J29C'...
       'M03C','M05C'};
...
wlen = 20;
t0 = -5;
hifrq = 0.3; % uppermost freq to fit (Hz)
...
scatter([data.slon],[data.slat],70,colour_get([data.Xrdg],min([data.Xrdg]),max([data.Xrdg])),'filled')
...
ylim([-3 2])
title(sprintf('Event %s gcarc=%.1f baz=%.0f',evtime,gcarc,baz),'FontSize',18)
