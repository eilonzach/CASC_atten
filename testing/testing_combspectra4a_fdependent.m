...
load('synthetic_tstar/eg_eqar_456ST.mat')
load('/Volumes/DATA_mini2/CASCADIA/DATA/269_201404122014/_EQAR_S_T.mat')  
...
parms.inv.alpha = 0.6;
[delta_tstar_1,delta_T_1,std_dtstar,pairwise,fmids] = combspectra_nofuss(dat,samprate,parms,0);
