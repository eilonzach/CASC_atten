...
if ifsave
save2pdf(1,'dTs_vs_dTp_indiv','figs'); pause(0.1)
end
...
if ifsave
save2pdf(2,'dtstars_vs_dtstarp_indiv','figs'); pause(0.1)
end
...
if ifsave
save2pdf(3,'dtstar_vs_dT_S_indiv','figs'); pause(0.1)
end
...
if ifsave
save2pdf(4,'dtstar_vs_dT_P_indiv','figs'); pause(0.1)
end
...
if ifsave
save2pdf(5,'dTs_vs_dTp_indiv_OBS','figs'); pause(0.1)
end
...
if ifsave
save2pdf(6,'dtstars_vs_dtstarp_indiv_OBS','figs'); pause(0.1)
end
...
% LOAD STAV RESULTS
load([resdir,'stav_dTxcorr_P_Z.mat']); stavR_dTp = results;
load([resdir,'stav_dTxcorr_S_T.mat']); stavR_dTs = results;
load([resdir,'stav_dtstar',specmethod,'_P_Z.mat']); stavR_dtstarp = results;
load([resdir,'stav_dtstar',specmethod,'_S_T.mat']); stavR_dtstars = results;
...
stav_yP   = stav_dTp~=0 & ~isnan(stav_dTp) & stav_dtstarp~=0 & ~isnan(stav_dtstarp) & abs(stav_dTp)<3 & abs(stav_dtstarp)<3;
stav_yS   = stav_dTs~=0 & ~isnan(stav_dTs) & stav_dtstars~=0 & ~isnan(stav_dtstars) & abs(stav_dTs)<5 & abs(stav_dtstars)<5;
...
if ifsave
save2pdf(11,'dTs_vs_dTp_stav','figs'); pause(0.1)
end
...
save2pdf(13,'dtstar_vs_dT_S_stav','figs'); pause(0.1)
...
if ifsave
save2pdf(14,'dtstar_vs_dT_P_stav','figs'); pause(0.1)
end
return
...
if ifsave
save2pdf(15,'dTs_vs_dTp_stav_OBS','figs'); pause(0.1)
end
...
if ifsave
save2pdf(16,'dtstars_vs_dtstarp_stav_OBS','figs'); pause(0.1)
end
